...
set N8N_PORT=5678
set SKILL=custom
set CUSTOM_SKILL_PATH=skills/skill_shelf_single_sample.md
set SKILL_REPO_PATH=skills/skill_shelf_single_sample.md
set SKILL_LABEL=Shelf Single Sample
...
start "moyin-worker-watcher-shelf-single-sample" cmd /k python workers\worker_watcher.py ^
...
:fail
echo %SKILL_LABEL% batch failed. If no submission is running, delete run.lock manually.
pause
exit /b 1
